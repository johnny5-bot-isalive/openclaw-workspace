...
- Review/approval routing preference: when Sammy needs Jaret to review or approve something, send markdown files to the Obsidian vault inbox and email drafts/items to Jaret's Gmail inbox unless a project workflow says otherwise.
